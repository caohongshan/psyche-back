...
var u = function(t) {
	...
	function tt(t, r) {
		...
		for (var f in t) !r && !F.call(t, f) || u && ("length" == f || o && ("offset" == f || "parent" ==
			f) || i && ("buffer" == f || "byteLength" == f || "byteOffset" == f) || vt(f, a)) || c.push(
			f);
		return c
	}

	function rt(t, r, e) {
		(void 0 !== e && !bt(t[r], e) || void 0 === e && !(r in t)) && ot(t, r, e)
	}

	function et(t, r, e) {
		var n = t[r];
		F.call(t, r) && bt(n, e) && (void 0 !== e || r in t) || ot(t, r, e)
	}

	function nt(t, r) {
		for (var e = t.length; e--;)
			if (bt(t[e][0], r)) return e;
		return -1
	}
	...
	function lt(t, r, e, n, o) {
		t !== r && ut(r, (function(i, u) {
			if (o || (o = new Z), Mt(i)) ! function(t, r, e, n, o, i, u) {
				var a = yt(t, e),
					f = yt(r, e),
					s = u.get(f);
				...
				if (h) {
					var p = wt(f),
						_ = !p && mt(f),
						v = !p && !_ && Ct(f);
					l = f, p || _ || v ? wt(a) ? l = a : xt(j = a) && Ot(j) ? l = function(
							t, r) {
							var e = -1,
								n = t.length;
							r || (r = Array(n));
				...
				var a = n ? n(yt(t, u), i, u + "", t, r, o) : void 0;
	...
	var jt = at(function() {
			...
			return xt(t) && F.call(t, "callee") && !B.call(t, "callee")
		},
		wt = Array.isArray;

	function Ot(t) {
		return null != t && zt(t.length) && !At(t)
	}
	var mt = G || function() {
		return !1
	};
	...
	var Ct = b ? function(t) {
		...
		return xt(t) && zt(t.length) && !!s[ct(t)]
	};

	function Ft(t) {
		return Ot(t) ? tt(t, !0) : st(t)
	}
	var Ut, St = (Ut = function(t, r, e) {
		lt(t, r, e)
	}, ht((function(t, r) {
		var e = -1,
			n = r.length,
			o = n > 1 ? r[n - 1] : void 0,
			i = n > 2 ? r[2] : void 0;
		for (o = Ut.length > 3 && "function" == typeof o ? (n--, o) : void 0, i && function(
				t, r, e) {
				if (!Mt(e)) return !1;
				var n = typeof r;
				return !!("number" == n ? Ot(e) && vt(r, e.length) : "string" == n && r in
					e) && bt(e[r], t)
...
class f {
	...
	config(t, r) {
		this._config || (this._config = (this.customMerge || u)(this.defaultConfig, this._getUserConfig()));
		let e = this._config;
